...
export const EnhancedItemCard: React.FC<EnhancedItemCardProps> = memo(
  ({ item, onSwipe, showActions = false, variant = "default" }) => {
            ...
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1 min-w-0">
                <h3
                  ...
                  } font-bold text-gray-900 mb-1 line-clamp-1`}
                >
                  {item.title}
                </h3>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-gray-900 truncate">{item.user.username}</p>
