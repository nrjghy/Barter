      ...
      >
        ...
        >
          <div className="px-5 pt-6 pb-4 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-barter-100 flex items-center justify-center text-barter-700 mb-3">
              <MapPin className="w-6 h-6" />
            </div>
            <h2 className="text-base font-bold text-[oklch(22%_0.02_100)] mb-1.5">
              Share your location to find nearby items
            </h2>
            <p className="text-[13.5px] text-[oklch(45%_0.02_95)]">
          ...
          <div className="px-5 pt-1 pb-5 flex flex-col gap-2">
            ...
            <button
              ...
              disabled={sharing}
              className="w-full py-3.5 rounded-2xl text-[oklch(45%_0.02_95)] text-sm font-semibold disabled:opacity-50"
            >
              Not now
            </button>
          </div>
