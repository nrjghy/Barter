...
export interface NotificationWithDetails {
  id: string;
  userId: string;
  type: "match" | "message" | "trade_completed" | "review" | "system" | "item_unavailable" | "review_reminder" | "issue_status" | "admin_daily_summary" | "trade_dispute" | "listing_expiry_reminder" | "pending_approval" | "like";
  title: string;
  content: string;
