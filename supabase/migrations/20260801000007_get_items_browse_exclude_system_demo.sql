-- =============================================================================
-- Barter: get_items_browse — exclude system and demo users from Discover
...
-- already live)
--
-- Context: system and demo accounts (users.is_system / users.is_demo) exist
-- for seeding/testing purposes and shouldn't surface as swipeable items in
-- the real pilot's Discover feed. Confirmed live via
--   SELECT pg_get_functiondef(p.oid) FROM pg_proc p
--   JOIN pg_namespace n ON n.oid = p.pronamespace
--   WHERE n.nspname = 'public' AND p.proname = 'get_items_browse';
